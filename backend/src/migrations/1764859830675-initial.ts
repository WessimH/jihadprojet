...
export class Initial1764859830675 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "games" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "category" character varying(50) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c9b16b62917b5595af982d66337" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."match_format" AS ENUM('BO1', 'BO3', 'BO5')`);
        ...
        await queryRunner.query(`CREATE TABLE "match_odds" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "odds" numeric(4,2) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "matchId" uuid, "teamId" uuid, CONSTRAINT "PK_b30dced875ae8e5538465cc722a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "matches" ADD CONSTRAINT "FK_142e2e9501f3c551d5d7fcd6fc0" FOREIGN KEY ("team1Id") REFERENCES "teams"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "matches" ADD CONSTRAINT "FK_b8621a9ae4f727940f1d28c8a2c" FOREIGN KEY ("team2Id") REFERENCES "teams"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "matches" ADD CONSTRAINT "FK_aaaeb9fd98fc66bbf57dea17677" FOREIGN KEY ("gameId") REFERENCES "games"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "bets" ADD CONSTRAINT "FK_ddd8dce54aa5f1af36c467c9dae" FOREIGN KEY ("matchId") REFERENCES "matches"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "bets" ADD CONSTRAINT "FK_bea9632c75f49d8a9d4ca3c0810" FOREIGN KEY ("teamId") REFERENCES "teams"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "match_odds" ADD CONSTRAINT "FK_a40b243cadeec63d06c2393950e" FOREIGN KEY ("matchId") REFERENCES "matches"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "match_odds" ADD CONSTRAINT "FK_ee4c2a6cb3fceefa5d99264e11c" FOREIGN KEY ("teamId") REFERENCES "teams"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "match_odds" DROP CONSTRAINT "FK_ee4c2a6cb3fceefa5d99264e11c"`);
        await queryRunner.query(`ALTER TABLE "match_odds" DROP CONSTRAINT "FK_a40b243cadeec63d06c2393950e"`);
        await queryRunner.query(`ALTER TABLE "bets" DROP CONSTRAINT "FK_bea9632c75f49d8a9d4ca3c0810"`);
        ...
        await queryRunner.query(`ALTER TABLE "matches" DROP CONSTRAINT "FK_aaaeb9fd98fc66bbf57dea17677"`);
        await queryRunner.query(`ALTER TABLE "matches" DROP CONSTRAINT "FK_b8621a9ae4f727940f1d28c8a2c"`);
        await queryRunner.query(`ALTER TABLE "matches" DROP CONSTRAINT "FK_142e2e9501f3c551d5d7fcd6fc0"`);
