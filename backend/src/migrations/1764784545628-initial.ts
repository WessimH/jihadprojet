...
export class Initial1764784545628 implements MigrationInterface {
  name = 'Initial1764784545628';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "bets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" numeric(8,2) NOT NULL, "odds" numeric(4,2) NOT NULL, "potential_payout" numeric(10,2) NOT NULL, "status" character varying(20) NOT NULL DEFAULT 'pending', "placed_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "matchId" uuid, "teamId" uuid, CONSTRAINT "PK_7ca91a6a39623bd5c21722bcedd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying(50) NOT NULL, "email" character varying(100) NOT NULL, "password_hash" character varying(255), "balance" numeric(10,2) NOT NULL DEFAULT '0', "total_bet" numeric(10,2) NOT NULL DEFAULT '0', "total_won" numeric(10,2) NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
